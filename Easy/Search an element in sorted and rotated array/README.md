<h2><a href="https://practice.geeksforgeeks.org/problems/search-in-a-rotated-array0959/1?page=12&difficulty[]=0&sortBy=submissions">Search an element in sorted and rotated array</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a sorted and rotated array <strong>A </strong>of N distinct elements which are rotated at some point, and given an element <strong>K</strong>. The task is to find the index of the given element K in array A.</span></p>
